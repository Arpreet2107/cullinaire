...
export const ABOUT = {
  ...
  content:
    "At Cullinaire, we believe that great food goes beyond taste; it tells a story of dedication and creativity. From our chef's signature creations to our attentive service, every detail is curated to ensure your visit is nothing short of exceptional. Whether you're savoring our renowned Tikka Kebab or exploring our diverse menu inspired by global flavors, each dish is a celebration of flavor and innovation. Join us for a culinary journey where every bite leaves a lasting impression. Experience Cullinaire—where every meal is a masterpiece.",
};

export const MISSION =
  "At our Cullinaire, our mission is to create delicious and memorable dining experiences.";
...
export const REVIEW = {
  ...
  content:
    "“As a seasoned food critic, my expectations are always high when stepping into a new dining establishment. Cullinaire, with its unassuming exterior and elegantly designed interior, promised a unique culinary experience from the moment I walked in. And I must say, it delivered beyond my expectations.”",
};

export const CONTACT = [
  { key: "address", value: "Address: KIIT University, Patia, Bhubaneswar, Odisha 751024" },
  { key: "phone", value: "Phone: +91 89982XXXXX" },
  { key: "email", value: "Email: contact@cullinaire.com" },
];
